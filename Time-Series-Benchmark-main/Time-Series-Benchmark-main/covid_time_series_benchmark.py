# -*- coding: utf-8 -*-
"""
Prepared by: Harsha Vardhan J, Created on 4th december 2024,  
...
df_confirmed = pd.read_csv(r'D:\myproject\Time-Series-Benchmark-main\Time-Series-Benchmark-main\time_series_covid19_confirmed_global.csv')
...
df_deaths = pd.read_csv(r'D:\myproject\Time-Series-Benchmark-main\Time-Series-Benchmark-main\time_series_covid19_deaths_global.csv')
...
df_recovered = pd.read_csv(r'D:\myproject\Time-Series-Benchmark-main\Time-Series-Benchmark-main\time_series_covid19_recovered_global.csv')
...
plt.ylabel('Cases', fontsize=2)
plt.title('Covid-19 confirmed cases (India, US, Australia)', fontsize=8)
...
mpl.rcParams['font.size'] = 10 #changed mpl.
plt.title(f'Covid-19 confirmed cases of {country} with LSTM', fontsize=8)
...
plt.legend(['train', 'test', 'pred'], fontsize=8)
plt.show()


print(f'Prediction of tomorrow is {int(predictions_LSTM[-1, 0])}')#changed predictions to lstm
...
plt.figure(figsize=(8, 4))
mpl.rcParams['font.size'] = 10 #changed mpl.
plt.title(f'Covid-19 confirmed cases of {country} with RNN', fontsize=12)
time_series = feature_1
train_time_series = time_series.iloc[640:train_len]
test_time_series = time_series.iloc[train_len-1:]
...
rcParams['font.size'] = 8 #changed mpl.
...
model_arima = sm.tsa.ARIMA(arima_data, order =(2, 0, 2))
...
mpl.rcParams['figure.dpi'] = 300
plt.figure(figsize=(8, 4))
rcParams['font.size'] = 10 #changed mpl.
plt.title(f'Covid-19 confirmed cases of {country} with ARIMA', fontsize=14)
time_series = feature_1
train_time_series = time_series.iloc[640:train_len]
test_time_series = time_series.iloc[train_len-1:]
